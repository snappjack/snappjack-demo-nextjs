          ...
          {reversedObjects.map((obj, reversedIndex) => {
            ...
            return (
              <div
                ...
                className={`bg-white dark:bg-gray-800 p-3 rounded border-2 cursor-pointer transition-all ${
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-1">
                    <button
                      ...
                      className="px-2 py-1 text-xs bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded disabled:opacity-50 disabled:cursor-not-allowed text-gray-700 dark:text-gray-300"
                      title="Move up"
                    >
                    ...
                    <button
                      ...
                      className="px-2 py-1 text-xs bg-red-100 dark:bg-red-900/20 hover:bg-red-200 dark:hover:bg-red-900/30 text-red-600 dark:text-red-400 rounded"
                      title="Delete"
                    >
      ...
      <div className="space-y-2 mt-3">
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="px-3 py-2 bg-blue-500 hover:bg-blue-600 text-white font-medium rounded transition-colors disabled:bg-gray-300 dark:disabled:bg-gray-700 disabled:cursor-not-allowed dark:disabled:text-gray-500 text-sm flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            disabled={isLoading}
            className="px-3 py-2 bg-green-500 hover:bg-green-600 text-white font-medium rounded transition-colors disabled:bg-gray-300 dark:disabled:bg-gray-700 disabled:cursor-not-allowed dark:disabled:text-gray-500 text-sm flex items-center justify-center gap-2"
          >
